...
$hashArray = Import-Csv C:\temp\installersArray.csv 
...
if (Test-Path "C:\temp\foundShortcuts.csv") {
    Remove-Item "c:\temp\foundShortcuts.csv" 
}
...
if (Test-Path "C:\temp\foundOldPreps.csv") {
...
if (Test-Path "C:\temp\TableauDesktop-64bit-2022-4-1.exe") {
